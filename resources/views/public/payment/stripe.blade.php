                ...
                <div class="col-md-6">
                    <div class="card">
                        <div class="card-header">
                            <h3 class="card-title mb-0">Pay with Stripe</h3>
                        </div>
                        <div class="card-body">
                            <form role="form" class="form-content row position-relative"
                                action="{{ url('appointment/checkout/status') }}" method="POST">
                                @csrf
                                @if ($errors->any())
                                ...
                                <div class="col-12 form-group mb-3">
                                    ...
                                    <div class="input-group">
                                        <input type="text" id="cardNo" class="form-control" name="cardNumber"
                                            placeholder="Card Number" size="20">
                                ...
                                <div class="col-4 form-group">
                                    ...
                                    <input type="number" name="cvv" class="form-control" size="4"
                                        placeholder="CVV">
                                </div>
                                <div class="col-4 form-group">
