...
<script src="{{asset('/assets/public/js/swiper.min.js')}}"></script>
<script src="{{asset('/assets/public/js/lightgallery.min.js')}}"></script>
<script src="{{asset('/assets/public/js/lg-fullscreen.min.js')}}"></script>
<script src="{{asset('/assets/public/js/lg-zoom.min.js')}}"></script>
<script src="{{asset('/assets/public/js/lg-share.min.js')}}"></script>
<script src="{{asset('/assets/public/js/lg-thumbnail.min.js')}}"></script>
