...
@section('content')
    ...
    <div class="content-wrapper">
        ...
        @component('admin.components.data-table', [
            'thead' => ['Appointment No.', 'Client Details', 'Date/Time', 'Services', 'Amount', 'Status', 'Action'],
        ])
            @slot('table_id')
                appointment-list
            @endslot
    ...
    {{-- status change modal --}}
    <div class="modal fade" id="changeAppointment-status" data-backdrop="static" data-keyboard="false" tabindex="-1"
