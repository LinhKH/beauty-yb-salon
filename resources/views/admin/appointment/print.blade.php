...
@section('content')
    ...
    <div class="content-wrapper">
        ...
        @component('admin.components.content-header', [
            'breadcrumb' => ['Dashboard' => 'admin/dashboard', 'Appointment' => 'admin/appointment'],
        ])
            @slot('title')
                Print Invoice
            @endslot
                                            ...
                                            <tbody>
                                                ...
                                                @foreach ($appointmentServices as $app_service)
                                                    <tr>
                                                        ...
                                                        <td><span
                                                                class="serviceTotal">{{ $app_service->service_price * $app_service->qty }}</span>
                                                    </tr>
                                                    @php
                                                        $app++;
                                                        $g_total += $app_service->service_price * $app_service->qty;
                                                    @endphp
                                                @endforeach
                                            </tbody>
                                            <tfoot>
