...
@component('admin.components.content-header',['breadcrumb'=>['Dashboard'=>'admin/dashboard','Gallery Image'=>'admin/gallery_img']])
    ...
    @slot('active') Add Gallery Image @endslot
@endcomponent
<!-- Main content -->
<section class="content card">
    <div class="container-fluid card-body">
        <!-- form start -->
        <form class="form-horizontal" id="addGalleryImg"  method="POST" enctype="multipart/form-data">
            @csrf
            <div class="row">
                <!-- column -->
                <div class="col-md-12">
                            ...
                            <div class="row">
                                <div class="col-md-6 col-12">
                                    <div class="form-group mb-4">
                                        <label>Gallery Image Name <small class="text-danger">*</small></label>
                                        <input type="text" class="form-control" name="title" placeholder="Please Gallery Image Name">
                                    </div>
                                </div>
                                <div class="col-md-6 col-12">
                                    <div class="form-group mb-4">
                                ...
                                <div class="col-md-12 col-12">
                                    <div class="form-group mb-4">
                                        ...
                                        <textarea name="description" class="form-control" rows="6" placeholder="Place some text here"></textarea>
                                    </div>
                                </div>
                            </div>
                            <div class="form-group row">
                                <label class="col-md-2">Gallery Image </label>
