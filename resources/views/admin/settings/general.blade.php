                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4 col-12">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="input-group" >
                                                ...
                                                <input type="text" name="phone" class="form-control" value="{{$item->com_phone}}" data-inputmask='"mask": "(999) 999-9999"' data-mask>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-4 col-12">
                                        <div class="form-group mb-4">
                                            ...
                                            <input type="text" class="form-control" name="f_address" value="{{$item->address_footer}}">
                                        </div>
                                    </div>
                                    <div class="col-md-4 col-12">
                                        <div class="form-group mb-4">
                                    ...
                                    <div class="col-md-4 col-12">
                                        <div class="form-group mb-4">
                                            ...
                                            <input type="number" class="form-control" name="discount" value="{{$item->booking_amount}}"  placeholder="Enter Booking Amount">
                                        </div>
                                    </div>
                                    <div class="col-md-4 col-12">
                                        <div class="form-group mb-4">
                                            <label>Map</label>
                                            <input type="text" class="form-control" name="map" value="{{$item->map}}"  placeholder="Enter Map Location">
                                        </div>
                                    </div>
